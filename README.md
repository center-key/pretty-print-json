...
##### HTML:
```html
<pre id=city-data class=json-container></pre>
```
##### JavaScript:
...
[🛡️ npm Security Aggregator](https://center-key.github.io/npm-security-aggregator/?package=pretty-print-json)

[Blog Post](https://blog.centerkey.com/2013/05/javascript-colorized-pretty-print-json.html), May 2013
